...
export const plantCoverImages = {
  semparuthi: {
    default: [`${BASE_COVER_PATH}/semparuthi-1.jpg`, `${BASE_COVER_PATH}/semparuthi-2.jpg`],
    variants: {
  ...
  ixora_white: {
    default: [`${BASE_COVER_PATH}/ixora_white-1.jpg`, `${BASE_COVER_PATH}/ixora_white-2.jpg`],
    variants: {
  ...
  ixora_pink: {
    default: [`${BASE_COVER_PATH}/ixora_pink-1.jpg`, `${BASE_COVER_PATH}/ixora_pink-2.jpg`],
    variants: {
  ...
  aralia_white: {
    default: [`${BASE_COVER_PATH}/aralia_white-1.jpg`, `${BASE_COVER_PATH}/aralia_white-2.jpg`],
    variants: {
  ...
  hawaiian_ti: {
    default: [`${BASE_COVER_PATH}/hawaiian_ti-1.jpg`, `${BASE_COVER_PATH}/hawaiian_ti-2.jpg`],
    variants: {
  ...
  pannir_rose: {
    default: [`${BASE_COVER_PATH}/pannir_rose-1.jpg`, `${BASE_COVER_PATH}/pannir_rose-2.jpg`],
    variants: {
  ...
  ixora_red: {
    default: [`${BASE_COVER_PATH}/ixora_red-1.jpg`, `${BASE_COVER_PATH}/ixora_red-2.jpg`],
    variants: {
  ...
  guava: {
    default: [`${BASE_COVER_PATH}/guava-1.jpg`, `${BASE_COVER_PATH}/guava-2.jpg`],
    variants: {
  ...
  golden_shower: {
    default: [`${BASE_COVER_PATH}/golden_shower-1.jpg`, `${BASE_COVER_PATH}/golden_shower-2.jpg`],
    variants: {
  ...
  wild_fig: {
    default: [`${BASE_COVER_PATH}/wild_fig-1.jpg`, `${BASE_COVER_PATH}/wild_fig-2.jpg`],
    variants: {
  ...
  croton_petra: {
    default: [`${BASE_COVER_PATH}/croton_petra-1.jpg`, `${BASE_COVER_PATH}/croton_petra-2.jpg`],
    variants: {
  ...
  mexican_mint: {
    default: [`${BASE_COVER_PATH}/mexican_mint-1.jpg`, `${BASE_COVER_PATH}/mexican_mint-2.jpg`],
    variants: {
  ...
  duranta: {
    default: [`${BASE_COVER_PATH}/duranta-1.jpg`, `${BASE_COVER_PATH}/duranta-2.jpg`],
    variants: {
