...
import { DEFAULT_IMAGE, IMAGE_BASEURL } from '@/constants';
import Image from 'next/image';

const imageUrls = Array.from({ length: 12 }, (_, i) => `${IMAGE_BASEURL}/gallery/${i + 2}.png`);
...
const Gallery = () => {
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-[var(--color-primary)] mb-8">Our Green Gallery</h2>
